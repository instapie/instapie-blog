  ...
  var Sketchy = {
    fromCanvas: function(canvas, options) {
      ...
      function createOverlay(canvas) {
        ...
        overlayElement.style.height = parseInt(canvasBounds.height) + 'px';
        overlayElement.style.width = parseInt(canvasBounds.width) + 'px';
        overlayElement.style.top = (window.pageYOffset + parseInt(canvasBounds.top)) + 'px';
        overlayElement.style.bottom = (window.pageYOffset + parseInt(canvasBounds.bottom)) + 'px';
        overlayElement.style.left = (window.pageXOffset + parseInt(canvasBounds.left)) + 'px';
        overlayElement.style.right = (window.pageXOffset + parseInt(canvasBounds.right)) + 'px';
